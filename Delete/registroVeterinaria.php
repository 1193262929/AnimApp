    ...
    <div class="page-wrapper">
        ...
        <main>
            <div class="container-formulario-registro text-center container-fluid py-2 d-flex justify-content-center">
                <form action="/AnimApp/models/registroVeterinaria.php" method="POST" class="bg-white w-50 p-3 my-5 d-flex flex-column rounded">
                    <h2 class="my-3">Crear cuenta veterinaria</h2>
                    <div class="row w-100">
