...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO veterinarias (nombre, telefono, direccion,  ciudad, descripcion, email, contraseña, verificarContraseña) VALUES (?, ?, ?, ?, ?, ?, ?, ?);";
    ...
    if (mysqli_stmt_execute($stmt)) {
        echo "<script>
             alert('Se registro de veterinaria exitosamente');
