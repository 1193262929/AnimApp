    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="menu">
            ...
            <?php if (isset($_SESSION['usuario']) && $_SESSION['usuario']['tipo'] === "normal"): ?>
                <div class="div-user col-4 d-sm-block">
                    <div class="dropdown m-auto col-xl-7 col-7 col-lg-9  bg-secondary">
                        <button class="btn btn-dark dropdown-toggle fw-bold w-100 " type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-person-circle me-2"></i> <?= $_SESSION['usuario']['email']; ?>
                        </button>
            ...
            <?php elseif (isset($_SESSION['usuario']) && $_SESSION['usuario']['tipo'] === "refugio"): ?>
                <div class="div-user col-4 d-lg-block d-xl-flex align-items-center justify-content-around gap-2">
            ...
            <?php elseif (isset($_SESSION['usuario']) && $_SESSION['usuario']['tipo'] === "tienda"): ?>
                <div class="div-user col-4 d-lg-block d-lg-flex align-items-center justify-content-center gap-2">
