...
<body>
    ...
    <main class="container-fluid">
        ...
        <div class="row row-tipo-usuario mt-5 justify-content-evenly">
            <div class="card">
                <img class="card-img-top" src="/AnimApp/assets/images/usuarioNormal.png" alt="">
                <div class="card-body">
                    ...
                    <a href="/AnimApp/views/login/registroUsuario.php" class="btn btn-success">Registrarme</a>
                </div>
            </div>

            <div class="card">
                <img class="card-img-top" src="/AnimApp/assets/images/refugio-de-animales.png" alt="">
                <div class="card-body">
                    ...
                    <a href="/AnimApp/views/login/registroRefugio.php" class="btn btn-success">Registrarme</a>
                </div>
            </div>

            <div class="card">
                <img class="card-img-top" src="/AnimApp/assets/images/tiendaAnimales.png" alt="">
                <div class="card-body">
                    ...
                    <a href="/AnimApp/views/login/registroTienda.php" class="btn btn-success">Registrarme</a>
                </div>
            </div>

            <div class="card">
                <img class="card-img-top" src="/AnimApp/assets/images/paseadorPerro.png" alt="">
                <div class="card-body">
                    ...
                    <a href="/AnimApp/views/login/registroPaseador.php" class="btn btn-success">Registrarme</a>
                </div>
            </div>

            <div class="card">
                <img class="card-img-top" src="/AnimApp/assets/images/veterinario.png" alt="">
                <div class="card-body">
                    ...
                    <a href="/AnimApp/views/login/registroVeterinaria.php" class="btn btn-success">Registrarme</a>
                </div>
            </div>
        </div>
        <div class="text-center mt-5">
            <a class="btn btn-dark col-lg-4 col-sm-6" href="/AnimApp/index.php">Volver a Inicio</a>
        </div>
    </main>
</body>
